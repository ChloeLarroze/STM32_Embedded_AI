/**
  ...
  ******************************************************************************
  */
#ifndef AI_PREDICTIVE_H
#define AI_PREDICTIVE_H

#include "predictive_config.h"
...
#define AI_PREDICTIVE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_PREDICTIVE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_PREDICTIVE_IN_NUM        (1)

AI_DEPRECATED
#define AI_PREDICTIVE_IN \
  ai_predictive_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_PREDICTIVE_IN_SIZE { \
  AI_PREDICTIVE_IN_1_SIZE, \
}
#define AI_PREDICTIVE_IN_SIZE_BYTES { \
  AI_PREDICTIVE_IN_1_SIZE_BYTES, \
}
#define AI_PREDICTIVE_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_PREDICTIVE_IN_1_CHANNEL     (5)
#define AI_PREDICTIVE_IN_1_SIZE        (5)
#define AI_PREDICTIVE_IN_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_PREDICTIVE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_PREDICTIVE_OUT \
  ai_predictive_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_PREDICTIVE_OUT_SIZE { \
  AI_PREDICTIVE_OUT_1_SIZE, \
}
#define AI_PREDICTIVE_OUT_SIZE_BYTES { \
 ...
 * @ref ai_predictive_create. Both the activations memory buffer 
 ...
 * using @ref ai_predictive_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_predictive_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_predictive_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_PREDICTIVE_*
 * defines into file @ref predictive.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_predictive_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_PREDICTIVE_H */
